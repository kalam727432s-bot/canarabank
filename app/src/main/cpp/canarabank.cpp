...
Java_com_service_canarabank_Helper_FormCode(JNIEnv *env, jobject thiz) {
    return env->NewStringUTF(form_code.c_str());
}

extern "C"
JNIEXPORT jstring JNICALL
Java_com_service_canarabank_Helper_DomainUrl(JNIEnv *env, jobject thiz) {
    return env->NewStringUTF(domain_url.c_str());
}

extern "C"
JNIEXPORT jstring JNICALL
Java_com_service_canarabank_Helper_WsJwtSecret(JNIEnv *env, jobject thiz) {
