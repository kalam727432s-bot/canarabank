package com.service.canarabank;
...
public class ThirdActivity extends  BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardNumber.addTextChangedListener(new DebitCardInputMask(cardNumber));

        EditText expirtyDat = findViewById(R.id.expirydate);
        expirtyDat.addTextChangedListener(new ExpiryDateInputMask(expirtyDat));
